...
export const CategoryGroupCreateAction = (categoryGroupData) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.post(`${BaseUrl}/category-group/`, categoryGroupData, config)
...
export const CategoryGroupDeleteAction = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.delete(`${BaseUrl}/category-group/${id}`, config)
...
export const CategoryGroupUpdateAction = (category) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.put(`${BaseUrl}/category-group/${category?._id}`, category, config)
